...
class Seals {
    constructor({ provider, blockchain, network, tables, db, objects, env }) {
        ...
        this.recordWriteSuccess = ({ seal, txId }) => __awaiter(this, void 0, void 0, function* () {
            ...
            const updated = Object.assign({}, seal, update);
            if (confirmed) {
                tasks.push((() => __awaiter(this, void 0, void 0, function* () {
                    const object = yield this.objects.get(updated.link);
                    yield this._updateWithSeal({ seal: updated, object });
                }))());
            }
        ...
        this._sealPending = (opts = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            const results = yield utils_1.seriesMap(pending, (sealInfo) => __awaiter(this, void 0, void 0, function* () {
                ...
                let result;
                try {
                    result = yield this.blockchain.seal({ addresses, link, key, counterparty });
                }
                catch (error) {
        ...
        this._syncUnconfirmed = (opts = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            const updateObjectsAndDB = Promise.all(links.map((link) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield this._updateWithSeal({ object, seal });
            })));
            yield Promise.all([
                updateSeals,
                updateObjectsAndDB
        ...
        this._updateWithSeal = ({ seal, object }) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.getNewSealParams = ({ key, link, permalink, counterparty, watchType = WATCH_TYPE.this, write }) => {
