...
exports.toModelsMap = models => _.transform(models, (result, model) => {
    result[model.id] = model;
}, {});
exports.ensureNoVirtualProps = resource => {
    if (validateResource.utils.hasVirtualDeep(resource)) {
        debugger;
        throw new Errors.InvalidObjectFormat(`virtual properties not allowed: ${string_utils_1.safeStringify(resource)}`);
    }
};
