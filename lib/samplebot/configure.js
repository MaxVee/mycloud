...
class Conf {
    constructor({ bot, logger }) {
        ...
        this.setCustomModels = (models) => __awaiter(this, void 0, void 0, function* () {
            const [org, current] = yield Promise.all([
                this.org.get(),
            ...
            yield this.modelStore.saveCustomModels({ models, namespace });
            yield this.models.putIfDifferent(models);
        });
        ...
        this.update = (update) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (models) {
                yield this.setCustomModels(models);
            }
            if (bot) {
